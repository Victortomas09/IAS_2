...
![Loop Effect Diagram](/assets/images/loop.png)

**Fig. 1.** The Loop Effect
...
![Application Layout - Data Tab](/assets/images/tab1.png)

**Fig. 2.** Application Layout - Data Tab
...
![Data Tab - The User-Item Matrix](/assets/images/tab1_user_item.png)

**Fig. 3.** Data Tab - The User-Item Matrix
...
![Recommendation Tab - Matrix Factorization](/assets/images/tab2_matrixfact.png)

**Fig. 4.** Recommendation Tab - Matrix Factorization

![Recommendation Tab - Predictions Matrix](/assets/images/tab2_Reconstructed_matrix.png)

**Fig. 5.** Recommendation Tab - Predictions Matrix
...
![Recommendation Tab - Top 20 User Recommendations](/assets/images/tab2_userrecomm.png)

**Fig. 6.** Recommendation Tab - Top 20 User Recommendations

![Recommendation Tab - 3D Latent Space Visualization](/assets/images/tab2_user_latent_space.png)

**Fig. 7.** Recommendation Tab - 3D Latent Space Visualization
