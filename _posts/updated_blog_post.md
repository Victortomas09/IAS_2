...
<p align="center">
  <img src="{{ site.baseurl }}/assets/images/loop.png" alt="Loop Effect Diagram" width="400"><br>
...
Truncating to the top $f$ singular values yields the $\text{rank-}f$ approximation:
...
##### Tabs and Features
 ...
 1. **Data Tab**
    ...
    <div style="display: flex; justify-content: space-between;">
      <div style="text-align: left; width: 48%;">
        <img src="{{ site.baseurl }}/assets/images/tab1.png" alt="Data Tab" width="100%"><br>
        <b>Fig. 2.</b> Application Layout - Data Tab
      </div>

      <div style="text-align: left; width: 48%;">
        <img src="{{ site.baseurl }}/assets/images/tab1_user_item.png" alt="Data Tab" width="100%"><br>
 ...
 2. **Recommendations Tab**
    ...
    <div style="display: flex; justify-content: space-between;">
      <div style="text-align: left; width: 48%;">
        <img src="{{ site.baseurl }}/assets/images/tab2_matrix_fact.png" alt="Data Tab" width="100%"><br>
        <b>Fig. 4.</b> Recommendation Tab - Matrix Factorization
      </div>

      <div style="text-align: left; width: 48%;">
        <img src="{{ site.baseurl }}/assets/images/tab2_Reconstructed_matrix.png" alt="Data Tab" width="100%"><br>
    ...
    <div style="display: flex; justify-content: space-between;">
      <div style="text-align: left; width: 48%;">
        <img src="{{ site.baseurl }}/assets/images/tab2_user_recomm.png" alt="Data Tab" width="100%"><br>
        <b>Fig. 6.</b> Recommendation Tab - Top 20 - User Recommendations
      </div>

      <div style="text-align: left; width: 48%;">
        <img src="{{ site.baseurl }}/assets/images/tab2_user_latent_space.png" alt="Data Tab" width="100%"><br>
...
[10] Article 27, Recommender system transparency [https://www.eu-digital-services-